...
import {allIdsByIdObjectStringOrNumber} from "../source/types";

it ("should remove multiple ids", () => {
    const theObject: {allIdsById: allIdsByIdObjectStringOrNumber} = {allIdsById: {allIds: [13, 14, 15], byId: {13: {test: true}, 14: {test: true}, 15: {test: true}}}};
...
it ("should handle empty ids arrays", () => {
    const theObject: {allIdsById: allIdsByIdObjectStringOrNumber} = {allIdsById: {allIds: [14], byId: {14: {test: true}}}};
